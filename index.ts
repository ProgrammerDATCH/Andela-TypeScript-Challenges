...
// function displayPerson(per: Person){
//     console.log(per)
// }
...
// const arr: number[] = [1,3,3,4,5,6,7,3,9,10];

// function countExistence(arr: number[]){
//     type countFormat = Record<number, number>;
//     let count: countFormat = {};
//     arr.forEach(el => {
...
// console.log(countExistence(arr))